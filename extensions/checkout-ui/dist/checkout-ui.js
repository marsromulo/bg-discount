...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const { extension: extension2, cost } = useApi();
    const [_minimum_order, setMinimumOrder] = (0, import_react16.useState)(0);
    const [_free_product, setFreeProduct] = (0, import_react16.useState)({});
    const [_cart_total, setCartTotal] = (0, import_react16.useState)(0);
    ...
    const [showGiftSection, setShowGiftSection] = (0, import_react16.useState)(true);
    (0, import_react16.useEffect)(() => {
      console.log("CHECKOUT PAGE");
      fetchMetafield();
      setCartTotal(cost.totalAmount.current.amount);
      setShowGiftSection(true);
      console.log("showGiftSection", showGiftSection);
    }, []);
    console.log("_cart_total", _cart_total);
    console.log("_minimum_order", _minimum_order);
    function fetchMetafield() {
      return __async(this, null, function* () {
        fetch("https://dev01.babycentral.co/index.php?route=bloom/discount/getOrderDiscountMetafield").then((response) => response.json()).then(
          (data) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: _cart_total > _minimum_order ? showGiftSection ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { status: "info", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "loose", id: "free-gift", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: 2, children: "FREE GIFT !" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { spacing: "loose", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        InlineLayout2,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { spacing: "none", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "large", emphasis: "strong", children: _free_product.title }) }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Button2,
              {
                kind: "primary",
