import { applyDecoratedDescriptor as _applyDecoratedDescriptor } from './_virtual/_rollupPluginBabelHelpers.mjs';
import { memoize } from '@shopify/decorators';
import { sanitiseDateString } from './sanitise-date-string.mjs';
