...
function HelpText({
  ...
  const productCombinesWithProduct = currentDiscountClass === constants.DiscountClass.Product && targetDiscountClass === constants.DiscountClass.Product;
  ...
  return count > 0 ? /*#__PURE__*/React__default["default"].createElement(polaris.Stack, {
    spacing: "none",
    vertical: true
  }, /*#__PURE__*/React__default["default"].createElement(polaris.TextStyle, {
    variation: "subdued"
  ...
  })), productCombinesWithProduct && /*#__PURE__*/React__default["default"].createElement(polaris.TextStyle, {
    variation: "subdued"
  }, i18n.translate('combinations.multipleEligibleDiscounts', {
    scope
  }))) : /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(polaris.TextStyle, {
    variation: "subdued"
