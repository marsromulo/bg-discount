...
const AUTOMATIC_REQUIREMENT_TYPES = [constants.RequirementType.Subtotal, constants.RequirementType.Quantity]; // see https://github.com/Shopify/web/pull/12361
...
function MinimumRequirementsCard({
  ...
  const [i18n] = reactI18n.useI18n(); // RequirementType.None is not valid for an automatic discount, so if the discount method changes we adjust the requirementType if the new state is invalid.
  ...
  const fieldHelpTextMarkup = /*#__PURE__*/React__default["default"].createElement(polaris.TextStyle, {
    variation: "subdued"
  ...
  const allMinimumRequirementChoices = [{
    ...
    renderChildren: isSelected => {
      return isSelected && /*#__PURE__*/React__default["default"].createElement(polaris.Stack, {
        vertical: true,
        spacing: "extraTight"
