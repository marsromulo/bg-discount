...
import { Stack, TextStyle, Button, Link } from '@shopify/polaris';
...
function HelpText({
  ...
  return count > 0 ? /*#__PURE__*/React.createElement(Stack, {
    spacing: "none",
    vertical: true
  ...
  })), productCombinesWithProduct && /*#__PURE__*/React.createElement(TextStyle, {
    variation: "subdued"
  }, i18n.translate('combinations.multipleEligibleDiscounts', {
    scope
  }))) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TextStyle, {
    variation: "subdued"
