...
import { getDateInUTC, getNewDateAtEndOfDay, getDateTimeInShopTimeZone } from '../../utilities/dates.esnext';
import { DEFAULT_WEEK_START_DAY } from '../../constants.esnext';
import { DatePicker } from '../DatePicker/DatePicker.esnext';
import { TimePicker } from '../TimePicker/TimePicker.esnext';
...
function ActiveDatesCard({
  ...
  const showEndDate = Boolean(endDate.value); // When start date or time changes, updates the end date to be later than start date (if applicable)
