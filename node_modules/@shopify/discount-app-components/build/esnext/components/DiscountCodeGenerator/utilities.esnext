import { DEFAULT_DISCOUNT_CODE_LENGTH } from '../../constants.esnext';
...
const generateRandomDiscountCode = (length = DEFAULT_DISCOUNT_CODE_LENGTH) => {
  if (length < 1) {
...
export { generateRandomDiscountCode };
