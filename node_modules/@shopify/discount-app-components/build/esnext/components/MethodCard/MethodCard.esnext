...
import { Card, Stack, Heading, TextStyle, ChoiceList, TextField } from '@shopify/polaris';
import { useI18n } from '@shopify/react-i18n';
import { DEFAULT_DISCOUNT_CODE_LENGTH, DiscountMethod, DiscountClass } from '../../constants.esnext';
...
function MethodCard({
  ...
  return /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(Card.Section, null, /*#__PURE__*/React.createElement(Stack, {
    distribution: "equalSpacing",
    alignment: "center"
  }, /*#__PURE__*/React.createElement(Heading, null, title), /*#__PURE__*/React.createElement(TextStyle, {
    variation: "subdued"
  }, getDiscountClassLabel(discountClass, i18n)))), /*#__PURE__*/React.createElement(Card.Section, {
