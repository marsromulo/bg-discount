...
import { Field, PositiveNumericString, CountryCode } from '~/types';
...
export declare function CountriesAndRatesCard({ countrySelectionType, selectedCountries, maximumShippingPrice, excludeShippingRates, countrySelector, currencyCode, }: CountriesAndRatesCardProps): JSX.Element;
