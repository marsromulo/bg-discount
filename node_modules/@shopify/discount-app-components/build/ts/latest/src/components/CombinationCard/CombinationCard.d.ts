...
import type { CombinableDiscountTypes, CombinableDiscountCounts, Field } from '~/types';
...
export declare function CombinationCard({ discountClass, discountDescriptor, combinableDiscountTypes, combinableDiscountCounts, discountId, }: CombinationCardProps): JSX.Element;
