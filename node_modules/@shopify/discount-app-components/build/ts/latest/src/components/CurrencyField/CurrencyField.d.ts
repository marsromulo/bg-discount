...
declare function CurrencyField({ currencyCode, hideCurrencyCode, hidePrefix, hideSuffix, appendSuffixToCurrency, suffix, prefix, ...rest }: CurrencyFieldProps): JSX.Element;
