...
export declare function FormattedNumberField({ value, format, unformat, noFormatting, autoComplete, placeholder, defaultToPlaceholder, onChange, onInput, onBlur, positiveOnly, minimumFractionDigits, maximumFractionDigits, ...textFieldProps }: FormattedNumberFieldProps): JSX.Element;
export {};
