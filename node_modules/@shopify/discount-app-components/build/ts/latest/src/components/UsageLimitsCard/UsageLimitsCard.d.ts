...
interface UsageLimitsCardMultiplePaymentsProps extends Omit<UsageLimitProps, 'isRecurring'> {
    /**
...
export declare function UsageLimitsCard(props: UsageLimitsCardProps): JSX.Element;
export {};
