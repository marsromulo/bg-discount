...
function useComplexI18n({
  ...
  if (manager !== managerRef.current) {
    ...
    unsubscribeRef.current = manager.subscribe(ids.current, ({
      ...
      const newI18n = new i18n.I18n(translations, _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, details), {}, {
        loading
      }));
  ...
  const [i18n$1, setI18n] = React__default["default"].useState(() => {
    ...
    return new i18n.I18n(translations, _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, manager.details), {}, {
      loading
    }));
  });
