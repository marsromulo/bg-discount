...
function translateWithDictionary(id, translations, locale, replacements, {
  ...
  const processedString = typeof result === 'string' && pseudotranslate ? i18n.pseudotranslate(result, _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, PSEUDOTRANSLATE_OPTIONS), {}, {
    toLocale: typeof pseudotranslate === 'boolean' ? undefined : pseudotranslate
  })) : result;

  if (typeof processedString === 'string') {
    return updateStringWithReplacements(processedString, _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, replacements), additionalReplacements));
  } else {
    return MISSING_TRANSLATION;
  }
}
  ...
  if (allReplacementsArePrimitives) {
    return str.replace(REPLACE_REGEX, match => {
      ...
      if (!Object.prototype.hasOwnProperty.call(replacements, replacement)) {
        throw new errors.MissingReplacementError(replacement, replacements);
      }
    ...
    while (match) {
      ...
      if (replacement) {
        ...
        matchIndex += 1;
        const finalReplacement = /*#__PURE__*/React__default["default"].isValidElement(replacements[replacement]) ? /*#__PURE__*/React__default["default"].cloneElement(replacements[replacement], {
          key: matchIndex
...
function updateTreeWithReplacements(translationTree, locale, replacements) {
  if (Object.prototype.hasOwnProperty.call(replacements, PLURALIZATION_KEY_NAME)) {
    ...
    if (typeof count === 'number') {
      ...
      if (typeof translationTree[group] === 'string') {
        return updateStringWithReplacements(translationTree[group], _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, replacements), {}, {
  ...
  return Object.keys(translationTree).reduce((acc, key) => _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, acc), {}, {
...
exports.PSEUDOTRANSLATE_OPTIONS = PSEUDOTRANSLATE_OPTIONS;
exports.getTranslationTree = getTranslationTree;
exports.memoizedNumberFormatter = memoizedNumberFormatter;
exports.memoizedPluralRules = memoizedPluralRules;
