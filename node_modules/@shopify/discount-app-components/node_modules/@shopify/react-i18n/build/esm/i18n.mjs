import { applyDecoratedDescriptor as _applyDecoratedDescriptor, objectSpread2 as _objectSpread2, objectWithoutProperties as _objectWithoutProperties } from './_virtual/_rollupPluginBabelHelpers.mjs';
...
import { RTL_LANGUAGES, DateStyle, dateStyle, WEEK_START_DAYS, DEFAULT_WEEK_START_DAY, EASTERN_NAME_ORDER_FORMATTERS } from './constants/index.mjs';
...
let I18n = (_dec = memoize(), (_class = class I18n {
  ...
  translate(id, optionsOrReplacements, replacements) {
    ...
    if (optionsOrReplacements == null) {
      ...
      normalizedOptions = _objectSpread2(_objectSpread2({}, optionsOrReplacements), {}, {
        replacements,
        pseudotranslate: pseudolocalize
      });
    } else {
  ...
  formatCurrency(amount, _ref2 = {}) {
    ...
    return this.formatNumber(amount, _objectSpread2({
      as: 'currency'
    }, options));
  }
  ...
  formatDate(date, options = {}) {
    ...
    const _ref3 = options || {},
      ...
      style = undefined
          ...
          formatOptions = _objectWithoutProperties(_ref3, _excluded3);

    if (style) {
      return style === DateStyle.Humanize ? this.humanizeDate(date, _objectSpread2(_objectSpread2({}, formatOptions), {}, {
        timeZone
      })) : this.formatDate(date, _objectSpread2(_objectSpread2({}, formatOptions), dateStyle[style]));
    }

    return formatDate(date, locale, _objectSpread2(_objectSpread2({}, formatOptions), {}, {
      timeZone
    }));
  }
  ...
  humanizePastDate(date, options) {
    ...
    return this.formatDate(date, _objectSpread2(_objectSpread2({}, options), {}, {
