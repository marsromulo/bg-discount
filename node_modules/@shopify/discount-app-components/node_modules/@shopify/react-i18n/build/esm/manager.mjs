import { asyncToGenerator as _asyncToGenerator, objectSpread2 as _objectSpread2 } from './_virtual/_rollupPluginBabelHelpers.mjs';
...
class I18nManager {
  ...
  resolve() {
    ...
    return _asyncToGenerator(function* () {
      yield Promise.all([..._this.translationPromises.values()]);
    })();
  }

  extract() {
    return [...this.asyncTranslationIds].reduce((extracted, id) => _objectSpread2(_objectSpread2({}, extracted), {}, {
