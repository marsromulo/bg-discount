...
var identifyScripts = require('./identifyScripts.js');
...
function tryAbbreviateName({
  ...
  if (new RegExp(`${index.UnicodeCharacterSet.Punctuation}|\\s`).test(combinedName)) {
    return undefined;
  }
  ...
  switch (script) {
    case index.UnicodeCharacterSet.Latin:
    ...
    case index.UnicodeCharacterSet.Han:
    case index.UnicodeCharacterSet.Katakana:
    case index.UnicodeCharacterSet.Hiragana:
      return lastNameTrimmed;

    case index.UnicodeCharacterSet.Hangul:
      if (firstNameTrimmed) {
    ...
    case index.UnicodeCharacterSet.Thai:
      if (firstNameTrimmed) {
        var _getGraphemes2;
