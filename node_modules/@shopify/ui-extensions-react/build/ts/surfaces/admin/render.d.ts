 ...
 * point you specified.
 */
export declare function reactExtension<ExtensionTarget extends RenderExtensionTarget>(target: ExtensionTarget, render: (api: ApiForRenderExtension<ExtensionTarget>) => ReactElement<any>): ExtensionTargets[ExtensionTarget];
